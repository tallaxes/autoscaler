...
require (
	...
	sigs.k8s.io/cloud-provider-azure v1.30.5
...
require (
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.0.39 // indirect
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/configloader v0.0.18 // indirect
